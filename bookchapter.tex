...
\todo{Miryung to Na: DND refactoring does not seem like a seminal paper. Reduce the space allocation of this example section to a half page as a recent technique after discussing some seminal papers first.} 
...
\todo{Miryung to Na. R3 does not seem like a seminal paper. Similarly, I will reduce the space to a half page} 
