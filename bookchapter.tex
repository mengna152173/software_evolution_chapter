...
Xing and Stroulia studied Eclipse's evolution history and found that 70\% of structural changes are due to refactorings and existing IDEs lack support for complex refactorings~\cite{Xing2006:eclipse}. Dig et al. studied the role of refactorings in API evolution and found that 80\% of the changes that break client applications are API-level refactorings~\cite{Dig2005}.  
...
\bibliography{tianyi,mengna,reference,miryung,kim,refs-kim,refs-wong,kimthesis,libsync,libsync2,chime,faultracer}
