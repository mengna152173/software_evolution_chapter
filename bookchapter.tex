...
\begin{figure}[ht]
 \centering
 \includegraphics[width=0.8\textwidth]{images/ChangeTypesTopics.pdf}
...
\todo{Na: should refactoring fit in the category of perfective change? or should it be in the category of preventive changes?} 
...
\todo{Na, could we move this part on TXL to Section 3.5 on automated change application? In my opinion is a TXL is a general program transforamtion technique and is more than cross-langauge software translation.} 
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=0.8\textwidth]{images/AutomatedChange.pdf}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=0.8\textwidth]{images/ChangeInspection.pdf}
...
cite this paper that discusses the inefficiency of formal code inspection.

@article{johnson1998reengineering,
...
The following work gives a good summary about code review concepts and practices but it is a little old. 

@article{meyer2008design,
...
This work seems to be the first to measure the factors that may influence the effectiveness of code review. 

@article{porter1998understanding,
...
Mockus et al.~studied the defects in Apache bug database and found the Apache project has a defect density comparable to proprietary software. They found that this was accomplished without a policy requiring substantial code reviews before a release. They comment that this result ``may indicate that fewer defects are injected into the code, or that other defect-finding activities such as inspections are conducted more frequently or more effectively''.
...
The seminal paper in code review practices (already cited)
...
\todo{Talk more about the outcomes of code
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=0.8\textwidth]{images/ChangeValidation.pdf} 
